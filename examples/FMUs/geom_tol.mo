model geom_tol
  Modelica.Blocks.Interfaces.RealOutput FR1_min_out annotation(
    Placement(transformation(origin = {84, 114}, extent = {{-10, -10}, {10, 10}}), iconTransformation(extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Interfaces.RealOutput FR1_max_out annotation(
  ...
  Modelica.Blocks.Interfaces.RealOutput FR2_min_out annotation(
    Placement(transformation(origin = {84, -29}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {18, -57}, extent = {{-10, -10}, {10, 10}})));
  Modelica.Blocks.Interfaces.RealOutput FR2_max_out annotation(
...
algorithm 
  // Lineare Einfluesse
  FR1_min_out := FR1_nom - R1/4 - S2/4;
  FR1_max_out := FR1_nom + R1/4 + S2/4;
  FR2_min_out := FR2_nom - C5/4 - N2/4;
  FR2_max_out := FR2_nom + C5/4 + N2/4;

  // Einfluss C4
  alpha_C4 := asin(C4/2 / (l_R + r_B));
  FR1_min_out := FR1_min_out - (Pos_FR1_R_y*(1 - cos(alpha_C4)) + Pos_FR1_R_x*sin(alpha_C4));
  FR1_max_out := FR1_max_out + (Pos_FR1_R_y*(1 - cos(alpha_C4)) + Pos_FR1_R_x*sin(alpha_C4));

  FR2_min_out := FR2_min_out - (Pos_FR2_RN_y*(1 - cos(alpha_C4)) + Pos_FR2_RN_x*sin(alpha_C4));
  FR2_max_out := FR2_max_out + (Pos_FR2_RN_y*(1 - cos(alpha_C4)) + Pos_FR2_RN_x*sin(alpha_C4));
  ...
  FR1_min_out := FR1_min_out - FR1_S4;
  FR1_max_out := FR1_max_out + FR1_S4;
  FR2_min_out := FR2_min_out - FR2_S4;
  FR2_max_out := FR2_max_out + FR2_S4;

  // Einfluss R4
  gamma_R4 := atan(R4 / Char_L_R4);
  FR2_R4 := Pos_FR2_N_y*(1 - cos(gamma_R4)) + Pos_FR2_N_x*sin(gamma_R4);
  FR2_min_out := FR2_min_out - FR2_R4;
  FR2_max_out := FR2_max_out + FR2_R4;
