...
extends Modelica.Icons.Example;
  ...
  Modelica.Blocks.Interfaces.RealInput in_torque annotation(
    Placement(transformation(origin = {-123, 27}, extent = {{-7, -7}, {7, 7}}), iconTransformation(origin = {-146, 62}, extent = {{-20, -20}, {20, 20}})));
initial equation
...
equation
  ...
  connect(in_torque, add3.u1) annotation(
    Line(points = {{-123, 27}, {-106, 27}, {-106, 10}, {-100, 10}}, color = {0, 0, 127}));
